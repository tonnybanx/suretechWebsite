...
<div>
    <h1 class="text-3xl text-black font-bold mt-40 lg:ml-52 ml-10">Conferences</h1>
</div>
...
<main class="container py-10">
    <div class="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6 lg:ml-52 ml-10 mr-10">
        ...
        try {
            $sql = "SELECT image_path, date, location, details, title FROM events WHERE category = 'conference'";
