<div class="w-full h-full" id="teamElement">
...
<div class="w-full h-full " >
       <!-- Tab Navigation -->
            <div class="mb-6 flex space-x-4 border-b h-[10vh] h-min-[100px]">
                <button class="tab-btn py-2 pr-4  border-b-2 border-blue-500 text-blue-500" id="tab-students" onclick="setActiveTab('students')">Students</button>
                <button class="tab-btn py-2 px-4 text-gray-600" id="tab-staff" onclick="setActiveTab('staff')">Staff</button>
   ...
   <div id="team_container" >
    ...
    <div id="students" class="students">
        <?php include 'dashboard_students.php'; ?>
    </div>
    <div id="staff" class="hidden">
        <?php include 'dashboard_staff.php'; ?>
    </div>
   </div> 
    </div>
